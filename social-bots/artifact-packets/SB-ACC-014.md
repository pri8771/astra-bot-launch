# Artifact packet — SB-ACC-014

Artifact: TikTok direct API fallback contract  
Milestone: V0.8  
Owner: ChatGPT  
Story points: n/a  
...
Define TikTok direct-API fallback requirements, account mapping, review/app constraints and readback verification.
