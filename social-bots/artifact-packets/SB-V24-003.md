# Artifact packet — SB-V24-003

Artifact: Failed-hypothesis archive  
Milestone: V2.4  
...
Preserve failed hypotheses and conditions so the system can avoid circular rediscovery while allowing justified retest after context changes.
