# Artifact packet — SB-V27-001

Artifact: Canonical idea lineage model  
Milestone: V2.7  
Owner: Claude-Core  
Story points: 3  
...
Represent one underlying idea separately from each platform execution, preserving source and experiment lineage.
