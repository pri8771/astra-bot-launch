# Artifact packet — SB-ACC-003

Artifact: Instagram route artifact  
Milestone: V0.8  
...
Prove the exact Instagram destination/account route, supported write/readback path and analytics route while keeping public authority disabled.
