# Artifact packet — SB-V07-004

Artifact: Host crash/restart/no-overlap acceptance bundle  
Milestone: V0.7  
...
Prove host crash/restart, stale takeover and no-overlap behavior under real scheduler execution.
