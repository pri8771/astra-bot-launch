# Artifact packet — SB-V06-002

Artifact: Social-B real dry-run packet  
Milestone: V0.6  
Owner: Claude-Core  
Story points: 3  
...
Run social-b through the complete zero-public-effect dry-run loop on newly captured current evidence.
