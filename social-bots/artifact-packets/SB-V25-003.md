# Artifact packet — SB-V25-003

Artifact: Audience segmentation privacy/safety acceptance  
Milestone: V2.5  
...
Prove segmentation excludes sensitive profiling, individual targeting and unsupported demographic inference.
