# Artifact packet — SB-V10-001

Artifact: Continuous three-bot operation acceptance run  
Milestone: V1.0  
Owner: Claude-Core  
Story points: 5  
...
Run all three bots continuously on real connected presences for the bounded acceptance window with real scheduling, receipts and owner gates.
