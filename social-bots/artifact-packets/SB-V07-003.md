# Artifact packet — SB-V07-003

Artifact: ChatGPT direction acknowledgement/consumption artifact  
Milestone: V0.7  
Owner: Claude-Core  
Story points: 3  
...
Prove a worker reads new canonical ChatGPT direction from GitHub, acknowledges the exact coordination ref, and executes without owner prompt relay.
