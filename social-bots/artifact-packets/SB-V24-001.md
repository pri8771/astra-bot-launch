# Artifact packet — SB-V24-001

Artifact: Institutional memory schema  
Milestone: V2.4  
Owner: Claude-Core  
Story points: 4  
...
Define long-horizon institutional memory for strategies, experiments, incidents, source trust and lessons with provenance/versioning.
