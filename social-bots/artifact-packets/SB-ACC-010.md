# Artifact packet — SB-ACC-010

Artifact: Buffer draft-only publishing adapter and destination validator  
Milestone: V0.8  
Owner: Claude  
Story points: 3  
...
Implement draft-only Buffer routing and destination validation with hard persona/destination mismatch stop and no public authority.
