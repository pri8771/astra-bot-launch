# Artifact packet — SB-V19-004

Artifact: Operator runbooks and recovery  
Milestone: V1.9  
...
Provide exact recovery runbooks for supported failures and prove they do not require code archaeology or hidden state.
