# Artifact packet — SB-V10-002

Artifact: Real measurement -> learning -> next-decision proof  
Milestone: V1.0  
...
For each bot, prove measured real-world evidence changes learning state and influences a later decision without metric fabrication.
