# Artifact packet — SB-V19-001

Artifact: Unattended soak suite  
Milestone: V1.9  
...
Run long unattended multi-bot acceptance with real scheduling and bounded fault injection; no open chat may be required.
