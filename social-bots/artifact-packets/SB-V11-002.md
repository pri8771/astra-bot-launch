# Artifact packet — SB-V11-002

Artifact: Reliability acceptance bundle  
Milestone: V1.1  
Owner: Claude-Core  
Story points: 3  
...
Accept reliability hardening only after the fault matrix, restart/idempotency and unattended-run evidence pass.
