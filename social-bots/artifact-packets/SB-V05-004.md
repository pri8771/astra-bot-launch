# Artifact packet — SB-V05-004

Artifact: Cultural-review evidence binding  
Milestone: V0.5  
...
Bind cultural review to attributable reviewer policy plus the exact evidence/source set used by the candidate; failed/unknown review must withhold.
