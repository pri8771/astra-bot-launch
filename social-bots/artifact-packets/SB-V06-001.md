# Artifact packet — SB-V06-001

Artifact: Social-A real dry-run packet  
Milestone: V0.6  
Owner: Claude-Core  
Story points: 3  
...
Run social-a through the complete zero-public-effect dry-run loop on newly captured current evidence.
